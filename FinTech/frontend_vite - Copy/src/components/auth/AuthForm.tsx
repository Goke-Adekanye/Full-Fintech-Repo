  ...
  return (
    <section className="grid md:grid-cols-3">
      <div className="p-6 bg-auth-section flex h-screen flex-col md:col-span-2">
        <div className="flex items-center justify-between max-[550px]:mb-4">
          <div className="inline-block cursor-pointer">
            <img src="icon.png" alt="" className="h-[50px]" />
          </div>
        </div>
        <div className="max-w-[425px] m-auto w-full">
          <h1 className="mb-2 text-[20px] min-[340px]:text-[24px] min-[420px]:text-[28px]">
            Welcome to Ape Banking
          </h1>
